...
class TrackedIssuesRepository(Protocol):
    ...
    def update_local_state(
        ...
        """Read and mutate one local state in a single transaction."""
...
class IssueLocalStateCommandService:
    ...
    def _persist_state(
        ...
        """Apply one mutation atomically to the latest persisted state."""
        return self._repository.update_local_state(target, update_state)
