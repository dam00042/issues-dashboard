...
class IssueLocalStatePayload(CamelModel):
    ...
    status: IssueLocalStatus | None = None
    ...
    def to_domain(self) -> IssueLocalState:
        ...
        return IssueLocalState(
            ...
            status=self.status
            or ("completed" if self.local_completed_at is not None else "active"),
        )
        ...
        return cls(
            ...
            local_state=(
                ...
                if not compact
                    ...
                    status=issue.local_state.status,
                )
            ),
...
class SyncStateItemPayload(IssueReferencePayload):
    ...
    def to_domain(self) -> IssueLocalStateChange:
        ...
        return IssueLocalStateChange(
            ...
            preserve_note_blocks="note_blocks" not in self.state.model_fields_set,
        )
