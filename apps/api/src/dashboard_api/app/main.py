...
from dashboard_api.application.preferences.service import DashboardPreferencesService
...
from dashboard_api.infrastructure.github.identity import GitHubIdentityClient
...
from dashboard_api.presentation.http.routes.backups import router as backups_router
...
from dashboard_api.presentation.http.routes.preferences import (
    router as preferences_router,
)
from dashboard_api.presentation.http.routes.session import (
    router as session_router,
)
from dashboard_api.presentation.http.routes.synchronization import (
...
def create_app(  # noqa: PLR0915
    ...
    preferences_service = DashboardPreferencesService(preferences_store)
    ...
    backup_service = DashboardBackupService(
        ...
        preferences_path=resolved_settings.preferences_path,
