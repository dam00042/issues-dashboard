...
DEFAULT_PREFERENCES_PATH = PROJECT_ROOT / "data" / "preferences.json"
...
class AppSettings(BaseSettings):
    ...
    desktop_mode: bool = Field(
        default=False,
        validation_alias="DASHBOARD_DESKTOP_MODE",
    )
    runtime_secret: str = Field(
        default="",
        validation_alias="DASHBOARD_RUNTIME_SECRET",
    )
